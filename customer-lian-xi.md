...
{% hint style="info" %}My97DatePickerBeta{% endhint %}
...
{% hint style="danger" %}注意sql语句问题{% endhint %}    
...
**物理分页的实现:**
 ...
 2. 使用数据库本身提供的分页操作.
    ...
    {% hint style="info" %}mysql:limit, sqlservlet:top, oracle:rownum
    {% endhint %}    
...
4. 在CustomerFindAllByPageServlet中处理请求参数 pageNum
```java
int pageNum = 1;
...
2. 关于页码显示
    ...
    &#x63CF;&#x8FF0;&#x5DF2;&#x81EA;&#x52A8;&#x751F;&#x6210;](.gitbook/assets/11%20%281%29.png)
